...
The Enterprise Education Resource Automation System (ERAS) is a low-code workflow automation solution designed to streamline education resource planning across multiple operational centres and headquarters.
...
- Stores structured delta records in Dataverse for reporting
...
- Triggers automated email notifications to authorised users
...
Interactive filters allow review by programme, subject, centre, and academic level, supporting data-driven operational decisions.
...
- Cross-platform integration (App, Automation, Reporting)
...
- Established scalable foundation for future system integration
...
No confidential organisational data, internal workflow exports, or proprietary materials are included.
